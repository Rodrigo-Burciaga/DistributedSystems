...
export class ResponseCodeNotFound extends GenericResponse implements ResponseServiceInterface {
    ...
    public fillResponse(httpError?: string, data?: any, extendDescription?: any): ResponseApi {
        ...
        this.responseApi.errorDescription = MessagesResponse.NOT_FOUND;
